CNT.ngModule.controller('undertakeCPTrendAnalysisController', [
	...
	'$parse',
	'$filter',
	function (undertakeCPTrendAnalysisService,
    $stateParams, $scope,
    gettextCatalog,
    T3_CabeceraPresentacionService, T3_CommunicationService, T3_TrazaService, T3_StateService, T3_LanguageService, PopupService, $state, T3_StorageService, $parse, $filter) {
		$scope.init = function () {
